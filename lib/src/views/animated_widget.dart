...
class CustomAnimatedWidget extends StatelessWidget {
  ...
  final Tween<Offset> slideTween = Tween(begin: const Offset(0.0, 0.02), end: Offset.zero);
...
abstract class BaseAnimatedState<T extends StatefulWidget> extends BaseState<T> with TickerProviderStateMixin {
