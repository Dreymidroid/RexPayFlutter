...
class Utils {
  static const MethodChannel methodChannel = const MethodChannel('plugins.wilburt/rexpay');
  ...
  static setCurrencyFormatter(String? currency, String? locale) =>
      _currencyFormatter = NumberFormat.currency(locale: locale, name: '$currency\u{0020}');
