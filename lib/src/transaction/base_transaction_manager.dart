...
import 'package:rexpay/src/views/birthday_widget.dart';
import 'package:rexpay/src/views/card_widget.dart';
import 'package:rexpay/src/views/otp_widget.dart';
import 'package:rexpay/src/views/pin_widget.dart';
...
abstract class BaseTransactionManager {
  ...
  Future<CheckoutResponse> getOtpFrmUI(
    ...
    if (otp != null && otp.isNotEmpty) {
      ...
      return notifyProcessingError(
          RexpayException("You did not provide an OTP"));
    }
  }
  ...
  Future<CheckoutResponse> getPinFrmUI() async {
    ...
    if (pin != null && pin.length == 4) {
      ...
      return notifyProcessingError(
          RexpayException("PIN must be exactly 4 digits"));
    }
  }
  ...
  Future<CheckoutResponse> getBirthdayFrmUI(
    ...
    if (birthday != null && birthday.isNotEmpty) {
      ...
      return notifyProcessingError(
          RexpayException("Date of birth not supplied"));
    }
  }
