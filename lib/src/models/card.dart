...
class PaymentCard {
  ...
  final List<CardType> cardTypes = [_Visa(), _MasterCard(), _AmericanExpress(), _DinersClub(), _Discover(), _Jcb(), _Verve()];
...
abstract class CardType {
  ...
  static final fullPatternMasterCard = RegExp(r'^(?:5[1-5][0-9]{2}|222[1-9]|22[3-9][0-9]|2[3-6][0-9]{2}|27[01][0-9]|2720)[0-9]{12}$');
  ...
  static final startingPatternMasterCard = RegExp(r'((5[1-5])|(222[1-9]|22[3-9][0-9]|2[3-6][0-9]{2}|27[01][0-9]|2720))');
  ...
  static final startingPatternJCB = RegExp(r'(2131)|(1800)(352[89])|(35[3-8]*[0-9])');
